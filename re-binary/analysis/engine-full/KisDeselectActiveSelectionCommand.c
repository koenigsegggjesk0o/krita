/* Class KisDeselectActiveSelectionCommand - decompiled from libkritaimage.so
 * SPDX-License-Identifier: GPL-2.0-or-later
 */

// ====== KisDeselectActiveSelectionCommand @ 0035b460 ======

/* KisDeselectActiveSelectionCommand::KisDeselectActiveSelectionCommand(KisSharedPtr<KisSelection>,
   KisWeakSharedPtr<KisImage>, KUndo2Command*) */

void __thiscall
KisDeselectActiveSelectionCommand::KisDeselectActiveSelectionCommand
          (KisDeselectActiveSelectionCommand *this,KisSharedPtr param_1,KisWeakSharedPtr param_2,
...

{
  ...
  piStack_30 = (int *)0x0;
LAB_0035b4ad:
                    /* try { // try from 0035b4b5 to 0035b4b9 has its CatchHandler @ 0035b5af */
  KisDeselectGlobalSelectionCommand::KisDeselectGlobalSelectionCommand
            ((KisDeselectGlobalSelectionCommand *)this,(KisWeakSharedPtr)local_38,param_3);
  piVar5 = piStack_30;
  auVar4._8_8_ = 0;
  ...
  *(undefined **)this = PTR_vtable_008370a8 + 0x10;
