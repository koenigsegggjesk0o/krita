/* Generated automatically from /builds/packaging/krita-deps-management/ext_python/_build/ext_python-prefix/src/ext_python/Modules/config.c.in by makesetup. */
/* -*- C -*- ***********************************************
