/* Ghidra-decompiled pseudocode of Krita BRUSH ENGINE CORE (libkritaimage/brushengine)
 * Source binary: libkritaimage.so.20.0.0 (krita-5.3.3 AppImage) - 7.3MB, 8224 functions
 * SPDX-License-Identifier: GPL-2.0-or-later
 *
 * THIS IS THE ACTUAL C++ BRUSH ENGINE - painting loop, paint information,
 * preset loading, registry, settings. The real KisPaintOp::paintDab() lives here.
 * NOTE: binary is stripped; class names recovered from dynamic symbols.
 * Variable names are lost (param_1, local_80, undefined4, etc).
 */
