...
- Box reset #6 recovery in parallel: fresh shallow clones (app@1b9c8b5 + builder@6d34ee8), Flutter 3.35.3 reinstall (tarball 1.4GB landed, extracting at beacon time). No Dart changes this loop; analyze to be recorded in the mirror note if the SDK finishes in time (last loop's analyze: 0 errors / 0 warnings; CI build gates green).
